...
This repository contains the reactexample OpenMRS Open Web App.
...
This will create a file called `reactexample.zip` file in the `dist` directory,
...
This will build and deploy the app to the `/Users/djazayer/openmrs/reactexample/owa/`
...
```js
{
  "LOCAL_OWA_FOLDER": "/Users/djazayer/openmrs/reactexample/owa/"
}
```
...
{
  "LOCAL_OWA_FOLDER": "/Users/djazayer/openmrs/reactexample/owa/",
  "APP_ENTRY_POINT": "http://localhost:8080/openmrs/owa/reactexample/index.html"
}
```
